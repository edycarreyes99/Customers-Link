...
export const invokeDeleteCustomer = createAction('[Customers] Invoke Delete Customer', props<{ customer: ICustomer }>());
...
export const deleteCustomerSuccess = createAction('[Customers] Customer Deleted from Data Source Successfully', props<{ customer: ICustomer }>());
